...
const TESTIMONIALS_DATA = [
  {
    ...
    content:
      'They are doing amazing job with absolute satisfaction, reducing our mean time to production by over 60%!',
  },
  {
    image: img2,
    heading: 'Verizon',
    ...
    content:
      'WebGuru has enabled us to manage extremely scalable infrastructure, spinning up environments with over thousands of resources.',
  },
  {
    image: img3,
    heading: 'Capital Rx',
    ...
    content:
      'Using WebGuru we\'ve eliminated configuration drift. They fit in seamlessly with our team, creating a positive environment for our engineers',
  }
];

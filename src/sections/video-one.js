  ...
  return (
    <Box as="section" sx={styles.video}>
      <Container>
        ...
        <Text as="p">
          Whether it's Cloud Migration, IaC, Policy Compliance, or - 
          <br/> 
          just telling people not to paste secrets in their code, we've been in your shoes.
        </Text>
      ...
      <ModalVideo
        channel="youtube"
        isOpen={videoOpen} // https://youtu.be/
        videoId="RO7VcUAsf-I"
